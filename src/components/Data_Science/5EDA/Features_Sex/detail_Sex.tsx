...
import Dataset_img from "public/datascience/feature_sex01.png";
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <p className="mt-4 mx-3 leading-relaxed text-xl text-gray-200">
            ดูความสัมพันธ์ของ feature จะเลือกใช้โดยการ plot ข้อมูล
          ...
          <ul className="mt-4 mx-3 leading-relaxed text-xl text-gray-200">
            <li>  - plot กราฟดูความสัมพันธ์ของข้อมูล </li>
            <li>  - เปลี่ยนรูปแบบข้อมูลจากตัวอักษร ให้เป็น ตัวเลข เพื่อให้ง่ายต่อการใช้งาน</li>
