...
import Alone_img from "public/datascience/feature_embarked01.png";
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <ul className="mt-4 mx-3 leading-relaxed text-xl text-gray-200">
            <li> - หาว่าท่าเรือไหนที่ผู้โดยสารใช้งานสูงสุด  </li>
            <li> - clean missing value with ท่าเรือที่ผู้โดยสารใช้งานสูงสุด  </li>
            <li> - convert feature ไปเป็น S, C, Q  ---&gt; 0, 1, 2  </li>           
          </ul>
          <br />
