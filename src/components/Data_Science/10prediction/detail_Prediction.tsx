...
import Predict_img from "public/datascience/predict_01.png";
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <p className="mt-4 mx-3 leading-relaxed text-xl text-gray-200">
            จะเป็นการนำข้อมูลชุด test มาป้อนให้กับ model เพื่อทำนายผมออกมาว่าให้จากข้อมูลที่ได้รับ model จะให้ผมรับแบบไหนออกมา
          </p>
