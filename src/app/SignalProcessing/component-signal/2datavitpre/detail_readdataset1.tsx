...
import Head from "public/signal/f.png";
      ...
      <div className="space-y-4">
        ...
        >
          <summary className="flex cursor-pointer items-center justify-between gap-1.5">
            ...
            การสร้าง Function  สำหรับ preprocessing 
            </h2>
          ...
          <div className="grid grid-cols-1 gap-1 lg:grid-cols-[120px_1fr] lg:gap-7 my-3 mx-10 px-8 leading-relaxed  text-gray-200">
            <div className="h-auto text-xl">scipy.fftpack()</div>
            <div className="h-auto text-lg ">
            Fast Fourier Transform (FFT) เป็นอัลกอริธึมที่มีประสิทธิภาพที่ใช้ในการคำนวณการแปลงฟูริเยร์แบบไม่ต่อเนื่อง ซึ่งเป็นเครื่องมือทางคณิตศาสตร์ที่ใช้กันทั่วไปในการประมวลผลสัญญาณ การวิเคราะห์ภาพ และสาขาอื่นๆ อีกมากมาย
          ...
          <div className="grid grid-cols-1 gap-1 lg:grid-cols-[120px_1fr] lg:gap-7 my-3 mx-10 px-8 leading-relaxed  text-gray-200">
            <div className="h-auto text-xl">fft.fft</div>
            <div className="h-auto text-lg ">
            fft.fftเป็นส่วนหนึ่งของscipy.fftpackโมดูลในไลบรารี SciPy ใช้เพื่อคำนวณ Fourier Transform (DFT) แบบไม่ต่อเนื่องหนึ่งมิติของอาร์เรย์อินพุต
          ...
          <div className="grid grid-cols-1 gap-1 lg:grid-cols-[120px_1fr] lg:gap-7 my-3 mx-10 px-8 leading-relaxed  text-gray-200">
            <div className="h-auto text-xl">fft.fftshift</div>
            <div className="h-auto text-lg ">
            ฟังก์ชันfftshiftรับอาร์เรย์ 1 มิติเป็นอินพุต
