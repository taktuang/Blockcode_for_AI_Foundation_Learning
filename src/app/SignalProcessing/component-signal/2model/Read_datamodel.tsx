  ...
  const childToParent = (childdata: any, id: number) => {
    ...
    if (childdata.option === "pre and save") {
      ...
      from ultralytics import YOLO
        # Use the model
        !yolo task=classify mode=train model=yolov8n-cls.pt data='/content/data/train_val' epochs=100 imgsz=224 optimizer=SGD patience=20 cos_lr=True #cos_lr = learning rate scheduler` }));
